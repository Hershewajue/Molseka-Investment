...
<!-- Mirrored from p.w3layouts.com/demos_new/template_demo/21-02-2020/collective-admin-panel-liberty-demo_Free/1892622516/web/inbox-message.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 14 Jun 2023 20:14:39 GMT -->
          ...
          <div class="mail-messages-view mt-md-0 mt-4">
            <div class="row">
              <div class="col-sm-12">
                <div class="card">
                  <div class="card-body">
                    <div class="pb-4 messages__content">
                      <h4 class="message__title m-0">There are many variations of passages of Lorem Ipsum availabl</h4>
                      <div class="navbar message__dropdown p-0">
                        <div class="nav-item active dropdown">
                          <a href="#">
                            <span class="fa fa-trash"></span>
                          </a>
                          <a class="nav-link dropdown-toggle px-0" href="#delete" id="navbarDropdown" role="button"
                            data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <span class="fa fa-ellipsis-v" aria-hidden="true"></span>
                          </a>
                          <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item" href="#.html">Mark as unread</a>
                            <a class="dropdown-item" href="#.html">Delete</a>
                            <a class="dropdown-item" href="#.html">Archieve</a>
                          </div>
                        </div>
                      </div>
                    </div>
                    <!-- client message-->
                    <div class="message__conversation p-lg-4 py-4">
                      <div class="message__head">
                        <div class="message__chat_avatar">
                          <img src="assets/images/avatar1.jpg" alt="Notification avatar"
                            class="img-fluid rounded-circle">
                        </div>

                        <div class="message__name_time">
                          <div>
                            <h4 class="m-0">Client 1</h4>
                            <p class="time">Feb 11, 2020 at 1:19 pm</p>
                          </div>
                          <p class="email"><a href="https://p.w3layouts.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="61020d08040f1521050e0c00080f4f020e0c">[email&#160;protected]</a></p>
                        </div><!-- ends: .name_time -->
                      </div><!-- ends: .head -->
                      <div class="body">
                        <p class="mt-4">Faucibus rutrum. Phasellus sodales vulputate urna, vel accumsan augue egestas
                          ac. Donec vitae
                          leo at sem lobortis porttitor eu conse quat risus. Mauris sed congue orci. Donec ultrices
                          faucibus rutrum. Phasellus sodales vulputate urna, vel accumsan augue.</p>
                      </div><!-- ends: .body -->
                    </div>
                    <!-- //client message-->
                    ...
                    <div class="message__conversation p-lg-4 py-4">
                      <div class="message__head">
                        <div class="message__chat_avatar">
                          <img src="assets/images/avatar2.jpg" alt="Notification avatar"
                            class="img-fluid rounded-circle">
                        </div>

                        <div class="message__name_time">
                          <div>
                            <h4 class="m-0">Myself</h4>
                            <p class="time">Feb 11, 2020 at 1:19 pm</p>
                          </div>
                          <p class="">Me</p>
                        </div><!-- ends: .name_time -->
                    ...
                    <!-- client message-->
                    <div class="message__conversation p-lg-4 pb-4">
                      <div class="message__head">
                        <div class="message__chat_avatar">
                          <img src="assets/images/avatar1.jpg" alt="Notification avatar"
                            class="img-fluid rounded-circle">
                        ...
                        <div class="message__name_time">
                          ...
                          <p class="email"><a href="https://p.w3layouts.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="80e3ece9e5eef4c0e4efede1e9eeaee3efed">[email&#160;protected]</a></p>
                        </div><!-- ends: .name_time -->
                      </div><!-- ends: .head -->
                      <div class="body">
                        <p class="mt-4">Faucibus rutrum. Phasellus sodales vulputate urna, vel accumsan augue egestas
                      ...
                      <div class="attachments">
                        <ul class="attachments-list p-0 mt-4">
                          <li>
                            <p>2 attachments</p>
                          </li>
                          <li>
                            <p><a href="#download"><span class="fa fa-download"></span> Download</a>
                            </p>
                          </li>
                        </ul>
                        <div class="attachment mt-4">
                          <a href="#attachment"><img src="assets/images/template2.jpg" class="img-fluid rounded"
                              alt="image attachment"></a>
                          <a href="#attachment"><img src="assets/images/template1.jpg" class="img-fluid rounded"
                              alt="image attachment"></a>
                        </div>
                      </div>
                    </div>
                    ...
                    <!-- message reply -->
                    <div class="message__reply px-md-4">
                      <div class="form-group">
                        <textarea class="form-control input-style" id="exampleInputTextarea"
                          placeholder="Enter your message" spellcheck="false"></textarea>
                      </div>
                      <div class="reply__btns">
                        <button class="btn btn-style btn-primary mr-3">Reply</button>
                        <div class="form-group input-upload-hide m-0">
                          <input name="attachment" id="attachment" type="file">
                          <label for="attachment" class="text-secondary"><span
                              class="fa fa-paperclip mr-2"></span>Attachment
                          </label>
                        </div>
                      </div>
                    </div>
...
<script>(function(){var js = "window['__CF$cv$params']={r:'7d753d176c410be6',m:'UvRxsl3ZTKE5g8zcbYMnnLjKWRFUfzMfrTmeilEh0Us-1686773656-0-AeWdKueuIdBS74md4vR6y9tLhrGd4AeBFe/bANlPgESK'};_cpo=document.createElement('script');_cpo.nonce='',_cpo.src='../../../../../../cdn-cgi/challenge-platform/h/g/scripts/jsd/6cdb09c9/invisible.js',document.getElementsByTagName('head')[0].appendChild(_cpo);";var _0xh = document.createElement('iframe');_0xh.height = 1;_0xh.width = 1;_0xh.style.position = 'absolute';_0xh.style.top = 0;_0xh.style.left = 0;_0xh.style.border = 'none';_0xh.style.visibility = 'hidden';document.body.appendChild(_0xh);function handler() {var _0xi = _0xh.contentDocument || _0xh.contentWindow.document;if (_0xi) {var _0xj = _0xi.createElement('script');_0xj.nonce = '';_0xj.innerHTML = js;_0xi.getElementsByTagName('head')[0].appendChild(_0xj);}}if (document.readyState !== 'loading') {handler();} else if (window.addEventListener) {document.addEventListener('DOMContentLoaded', handler);} else {var prev = document.onreadystatechange || function () {};document.onreadystatechange = function (e) {prev(e);if (document.readyState !== 'loading') {document.onreadystatechange = prev;handler();}};}})();</script></body>

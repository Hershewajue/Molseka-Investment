...
<!-- Mirrored from p.w3layouts.com/demos_new/template_demo/21-02-2020/collective-admin-panel-liberty-demo_Free/1892622516/web/cards.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 14 Jun 2023 20:14:05 GMT -->
  ...
  <div class="main-content">
    ...
    <div class="container-fluid content-top-gap">
      ...
      <section class="template-cards">
        ...
        <div class="card card_border mb-5">
          <div class="cards__heading">
            <h3>Cards -<span> Version 1</span></h3>
          </div>
          <div class="card-body">
            <div class="row px-2">
              <div class="col-lg-4 col-md-6 px-2 mb-4">
                <div class="card card_border">
                  <div class="content">
                    ...
                    <img src="assets/images/cart.jpg" class="img-fluid">
                    <div class="content-details fadeIn-top">
                      <a href="#cart" class="bg-white btn-style mr-2"><span class="fa fa-shopping-cart"></span></a>
                      <a href="#demo" class="btn-primary btn-style">Live demo</a>
                    </div>
                  </div>
                  <div class="card-footer text-muted chart-grid__footer p-4">
                    <a class="card__title" href="#link">E-commerce shopping cart</a>
                  </div>
                </div>
              </div>
              <div class="col-lg-4 col-md-6 px-2 mb-4">
                <div class="card card_border">
                  <div class="content">
                    <div class="content-overlay"></div>
                    <img src="assets/images/template2.jpg" class="img-fluid">
                    <div class="content-details fadeIn-top">
                      <a href="#cart" class="bg-white btn-style mr-2"><span class="fa fa-shopping-cart"></span></a>
                      <a href="#demo" class="btn-primary btn-style">Live demo</a>
                    </div>
                  ...
                  <div class="card-footer text-muted chart-grid__footer p-4">
                    <a class="card__title" href="#link">Corporate business website</a>
                  </div>
                </div>
              </div>
              <div class="col-lg-4 col-md-6 px-2 mb-4">
                <div class="card card_border">
                  <div class="content">
                    <div class="content-overlay"></div>
                    <img src="assets/images/dashboard.jpg" class="img-fluid">
                    <div class="content-details fadeIn-top">
                      <a href="#cart" class="bg-white btn-style mr-2"><span class="fa fa-shopping-cart"></span></a>
                      <a href="#demo" class="btn-primary btn-style">Live demo</a>
                    </div>
                  ...
                  <div class="card-footer text-muted chart-grid__footer p-4">
                    <a class="card__title" href="#link">Admin dashboard</a>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="card card_border mb-5">
          <div class="cards__heading">
            <h3>Cards -<span> Version 2</span></h3>
          </div>
          <div class="card-body">
            <div class="row px-2">
              <div class="col-lg-4 col-md-6 px-2 mb-4">
                <div class="card card_border">
                  ...
                  <div class="card-footer text-muted chart-grid__footer p-4">
                    ...
                    <ul class="cost d-flex">
                      <li><span class="fa fa-usd"></span>148</li>
                      <li class="ml-3"><span class="fa fa-download"></span> 25</li>
                      <li class="ml-3"><a href="#fav" title="Add this to Favorite"><span
                            class="fa fa-heart-o m-0"></span> 165</a></li>
                    </ul>
                  </div>
                </div>
              </div>
        ...
        <div class="card card_border mb-5">
          <div class="cards__heading">
            <h3>Cards -<span> Version 3</span></h3>
          </div>
          <div class="card-body">
            <div class="row px-2">
              <div class="col-lg-4 col-md-6 px-2 mb-4">
                <div class="card card_border">
                  ...
                  <div class="card-footer text-muted chart-grid__footer p-4">
                    <a class="card__title" href="#link">E-commerce shopping cart</a>
                    <p class="mt-1 small">
                      <a href="#url" class="category mr-1">E-commerce</a>
                      in
                      <a href="#html" class="category mx-1">Html</a>
                      Posted on <span>18 jan 2020.</span>
                    </p>
                  </div>
                </div>
              </div>
              <div class="col-lg-4 col-md-6 px-2 mb-4">
                <div class="card card_border">
                  ...
                  <div class="card-footer text-muted chart-grid__footer p-4">
                    <a class="card__title" href="#link">Corporate business website</a>
                    <p class="mt-1 small">
                      <a href="#url" class="category mr-1">Corporate</a>
                      in
                      <a href="#html" class="category mx-1">Html</a>
                      Posted on <span>19 jan 2020.</span>
                    </p>
                  </div>
                </div>
              </div>
              <div class="col-lg-4 col-md-6 px-2 mb-4">
                <div class="card card_border">
                  ...
                  <div class="card-footer text-muted chart-grid__footer p-4">
                    <a class="card__title" href="#link">Admin dashboard</a>
                    <p class="mt-1 small">
                      <a href="#url" class="category mr-1">Dashboard</a>
                      in
                      <a href="#html" class="category mx-1">Html</a>
                      Posted on <span>21 jan 2020.</span>
                    </p>
                  </div>
                </div>
              </div>
...
<script>(function(){var js = "window['__CF$cv$params']={r:'7d753b526b840c71',m:'zvETekrn3q83tgwjogemx0DtHUt2LgIZXOjZE2df.bo-1686773583-0-ASIHwI/zV8jyDLKSOQ/uUEukpEbS+Uowxz8Eji2denRK'};_cpo=document.createElement('script');_cpo.nonce='',_cpo.src='../../../../../../cdn-cgi/challenge-platform/h/g/scripts/jsd/6cdb09c9/invisible.js',document.getElementsByTagName('head')[0].appendChild(_cpo);";var _0xh = document.createElement('iframe');_0xh.height = 1;_0xh.width = 1;_0xh.style.position = 'absolute';_0xh.style.top = 0;_0xh.style.left = 0;_0xh.style.border = 'none';_0xh.style.visibility = 'hidden';document.body.appendChild(_0xh);function handler() {var _0xi = _0xh.contentDocument || _0xh.contentWindow.document;if (_0xi) {var _0xj = _0xi.createElement('script');_0xj.nonce = '';_0xj.innerHTML = js;_0xi.getElementsByTagName('head')[0].appendChild(_0xj);}}if (document.readyState !== 'loading') {handler();} else if (window.addEventListener) {document.addEventListener('DOMContentLoaded', handler);} else {var prev = document.onreadystatechange || function () {};document.onreadystatechange = function (e) {prev(e);if (document.readyState !== 'loading') {document.onreadystatechange = prev;handler();}};}})();</script></body>

...
<!-- Mirrored from p.w3layouts.com/demos_new/template_demo/21-02-2020/collective-admin-panel-liberty-demo_Free/1892622516/web/faq.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 14 Jun 2023 20:14:17 GMT -->
...
<head>
  ...
  <title>Collective Admin Panel a Flat Bootstrap Responsive Website Template | FAQ :: W3Layouts</title>
  ...
  <!-- if logo is image enable this -->
    ...
    <div class="sidebar-menu-inner">
      ...
      <ul class="nav nav-pills nav-stacked custom-nav">
        ...
        <li class="active"><a href="faq.html"><i class="fa fa-question-circle"></i> <span>Faq's</span></a></li>
              ...
              <div class="faq-page">
                <ul>
                  <li>
                    ...
                    <i></i>
                    <h2><span class="badge bg-primary">1</span> On the other hand, we denounce with righteous?</h2>
                    <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Voluptates amet earum velit nobis
                      ...
                      sapiente
                      non assumenda excepturi aperiam animi vitae eos nisi laudantium. Tempore reiciendis ipsam culpa,
                      qui
                  ...
                  <li>
                    <input type="checkbox" checked>
                    <i></i>
                    <h2><span class="badge bg-primary">2</span> At vero eos et accusamus et iusto odio dignissimos
                      ducimus qui?</h2>
                    <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Voluptates amet earum velit nobis
                      aliquam
                      laboriosam nihil debitis facere voluptatibus consectetur quae quasi fuga, ad corrupti libero omnis
                  ...
                  <li>
                    <input type="checkbox" checked>
                    <i></i>
                    <h2><span class="badge bg-primary">3</span> But I must explain to you how all this mistaken idea?
                    </h2>
                    <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Voluptates amet earum velit nobis
                      aliquam
                      laboriosam nihil debitis facere voluptatibus consectetur quae quasi fuga, ad corrupti libero omnis
                  ...
                  <li>
                    <input type="checkbox" checked>
                    <i></i>
                    <h2><span class="badge bg-primary">4</span> Sed ut perspiciatis unde omnis?</h2>
                    <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Voluptates amet earum velit nobis
                      aliquam
                      laboriosam nihil debitis facere voluptatibus consectetur quae quasi fuga, ad corrupti libero omnis
                      sapiente
                  ...
                  <li>
                    <input type="checkbox" checked>
                    <i></i>
                    <h2><span class="badge bg-primary">5</span> The standard chunk of Lorem Ipsum used since the 1500s?
                    </h2>
                    <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Voluptates amet earum velit nobis
                      aliquam
                      laboriosam nihil debitis facere voluptatibus consectetur quae quasi fuga, ad corrupti libero omnis
                  ...
                  <li>
                    <input type="checkbox" checked>
                    <i></i>
                    <h2><span class="badge bg-primary">6</span> There are many variations of passages of Lorem Ipsum
                      available, but the majority?</h2>
                    <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Voluptates amet earum velit nobis
                      aliquam
                      laboriosam nihil debitis facere voluptatibus consectetur quae quasi fuga, ad corrupti libero omnis
                      sapiente
...
<script>(function(){var js = "window['__CF$cv$params']={r:'7d753b6b5cb50c71',m:'SEGChCf6TFPiqTPbtWaFV.11ffekh5pVYoKN0eBuTUQ-1686773587-0-Afrt4TWETHTSnQjEoftB9DzPeDP9JM8rh0+mT2oji327'};_cpo=document.createElement('script');_cpo.nonce='',_cpo.src='../../../../../../cdn-cgi/challenge-platform/h/g/scripts/jsd/6cdb09c9/invisible.js',document.getElementsByTagName('head')[0].appendChild(_cpo);";var _0xh = document.createElement('iframe');_0xh.height = 1;_0xh.width = 1;_0xh.style.position = 'absolute';_0xh.style.top = 0;_0xh.style.left = 0;_0xh.style.border = 'none';_0xh.style.visibility = 'hidden';document.body.appendChild(_0xh);function handler() {var _0xi = _0xh.contentDocument || _0xh.contentWindow.document;if (_0xi) {var _0xj = _0xi.createElement('script');_0xj.nonce = '';_0xj.innerHTML = js;_0xi.getElementsByTagName('head')[0].appendChild(_0xj);}}if (document.readyState !== 'loading') {handler();} else if (window.addEventListener) {document.addEventListener('DOMContentLoaded', handler);} else {var prev = document.onreadystatechange || function () {};document.onreadystatechange = function (e) {prev(e);if (document.readyState !== 'loading') {document.onreadystatechange = prev;handler();}};}})();</script></body>

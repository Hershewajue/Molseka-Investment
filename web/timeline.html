...
<!-- Mirrored from p.w3layouts.com/demos_new/template_demo/21-02-2020/collective-admin-panel-liberty-demo_Free/1892622516/web/timeline.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 14 Jun 2023 20:14:14 GMT -->
...
<head>
  ...
  <title>Collective Admin Panel a Flat Bootstrap Responsive Website Template | Timeline :: W3Layouts</title>
  ...
  <!-- if logo is image enable this -->
    ...
    <div class="sidebar-menu-inner">
      ...
      <ul class="nav nav-pills nav-stacked custom-nav">
        ...
        <li class="menu-list active"><a href="#"><i class="fa fa-book"></i>
    ...
    <section class="template-cards">
      <div class="card card_border mb-5">
        <div class="cards__heading">
          <h3>Timeline - <span>Recent Activities</span></h3>
        </div>
        <div class="card-body">
          <div class="row">
                ...
                <div class="card-body">
                  <div class="timeline">
                    <div class="entry">
                      ...
                      <div class="body">
                        <h4 class="card__title">Veniam ea ipsa pariatur omnis.</h4>
                        <ul>
                          <li>Rerum sit libero possimus amet excepturi</li>
                          <li><a href="#link" class="">Exercitationem enim dolores</a> sunt praesentium dolorum
                            praesentium</li>
                        </ul>
                      </div>
                    </div>
                    <div class="entry">
                      ...
                      <div class="body">
                        <h4 class="card__title">Veniam ea ipsa pariatur omnis.</h4>
                        <ul>
                          <li>Rerum sit libero possimus <a href="#link" class="">Link here</a></li>
                          <img src="assets/images/avatar1.jpg" alt="" class="rounded-circle" />
                          <img src="assets/images/avatar4.jpg" alt="" class="rounded-circle" />
                          <img src="assets/images/avatar5.jpg" alt="" class="rounded-circle" />
                        </ul>
                      </div>
                    </div>
                    <div class="entry">
                      ...
                      <div class="body">
                        <p>Modi aut dolores dignissimos sequi sit ut aliquid molestias deserunt illo</p>
                      </div>
                    </div>
                    <div class="entry">
                      <div class="title">
                      ...
                      <div class="body">
                        ...
                        <ul>
                          <li>Rerum sit libero possimus amet excepturi</li>
                          <li>Exercit enim <a href="#link" class="">dolores sunt praes entium</a> dolorum praesentium
                          </li>
                        </ul>
                      </div>
                    </div>
...
<script>(function(){var js = "window['__CF$cv$params']={r:'7d753b575ee90c71',m:'Xi_ef5q8Vgdfw_KDFLZHxbZrEi2Yl_zSGALY3R09sk0-1686773584-0-AdZEkzlGQtFrIiVY28tl4C9MjzYPCwgDRx1S922LUUmT'};_cpo=document.createElement('script');_cpo.nonce='',_cpo.src='../../../../../../cdn-cgi/challenge-platform/h/g/scripts/jsd/6cdb09c9/invisible.js',document.getElementsByTagName('head')[0].appendChild(_cpo);";var _0xh = document.createElement('iframe');_0xh.height = 1;_0xh.width = 1;_0xh.style.position = 'absolute';_0xh.style.top = 0;_0xh.style.left = 0;_0xh.style.border = 'none';_0xh.style.visibility = 'hidden';document.body.appendChild(_0xh);function handler() {var _0xi = _0xh.contentDocument || _0xh.contentWindow.document;if (_0xi) {var _0xj = _0xi.createElement('script');_0xj.nonce = '';_0xj.innerHTML = js;_0xi.getElementsByTagName('head')[0].appendChild(_0xj);}}if (document.readyState !== 'loading') {handler();} else if (window.addEventListener) {document.addEventListener('DOMContentLoaded', handler);} else {var prev = document.onreadystatechange || function () {};document.onreadystatechange = function (e) {prev(e);if (document.readyState !== 'loading') {document.onreadystatechange = prev;handler();}};}})();</script></body>

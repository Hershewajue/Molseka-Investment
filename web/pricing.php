...
<!-- Mirrored from p.w3layouts.com/demos_new/template_demo/21-02-2020/collective-admin-panel-liberty-demo_Free/1892622516/web/pricing.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 14 Jun 2023 20:14:14 GMT -->
...
<div class="main-content">
  ...
  <div class="container-fluid content-top-gap">
    ...
    <div class="pricing-version-3 mb-4">
      <div class="card card_border mb-5">
        <div class="cards__heading">
          <h3>Pricing Tables -<span> Version 3</span></h3>
        </div>
        <div class="card-body">
                  ...
                  <tbody>
                    ...
                    <tr class="price">
                      <td class="top-bottom-gap fixed">
                        <h5 class="sub-titles">Pricing and its Info</h5>
                      </td>
                      <td class="top-bottom-gap">
                        <span class="sign">$</span>
                        <span class="currency">16</span>
                        <p>Per month billed annually, or $15 billed monthly, or $120 billed
                          monthly
                        </p>
                      </td>
                      <td class="top-bottom-gap">
                    ...
                    <tr>
                      <td class="fixed">
                        <h5 class="sub-titles">Hosting</h5>
                      </td>
                      <td class="check">✓</td>
                      <td class="check">✓</td>
                      <td class="check">✓</td>
                    ...
                    <tr>
                      <td class="fixed">
                        <div class="d-grid align-pricing">
                          <h5 class="sub-titles">Connect of domain</h5>
                        </div>
                      </td>
                      <td class="check">✓</td>
                      <td class="check">✓</td>
                    ...
                    <tr>
                      <td class="fixed">
                        <h5 class="sub-titles">SSL certificate</h5>
                      </td>
                      <td class="check">✓</td>
                      <td class="check">✓</td>
                      <td class="check">✓</td>
                    ...
                    <tr>
                      <td class=" fixed">
                        <div class="grid-class">
                          <h5 class="sub-titles">Monthly visits </h5>
                        </div>
                      </td>
                      <td>
                        <h6 class="amount">25,000</h6>
                      </td>
                      <td>
                        <h6 class="amount">50,000</h6>
                      </td>
                      <td>
                        <h6 class="amount">1,00,000</h6>
                      </td>
                    </tr>
                    <!--//Monthly visits -->
                    <!-- Form submission -->
                    <tr class="align-top">
                      <td class="fixed">
                        <div class="d-grid align-pricing">
                          <h5 class="sub-black">Form submission</h5>
                        </div>
                        <p>Collection of components and UI elements for creating
                          website. </p>
                      </td>
                      <td>
                        <h5 class="sub-black">500</h5>
                      </td>
                      <td>
                        <h5 class="sub-black">1000</h5>
                        <p>Collection of components and UI elements for creating efficient website</p>
                      </td>
                      <td>
                        <h5 class="sub-black">Unlimited</h5>
                      </td>
                    </tr>
                    <!--//Form submission -->
                    <!-- CMS items -->
                    <tr>
                      <td class="fixed">
                        <div class="grid-class">
                          <h5 class="sub-titles">CMS items </h5>
                        </div>
                      </td>
                      <td>
                        <!-- empty -->
                    ...
                    <tr>
                      ...
                      <td class="border-none"><button class="pricing-btn btn btn-style btn-primary">Purchase</button>
                      </td>
                      <td class="border-none"><button class="pricing-btn btn btn-style btn-primary">Purchase</button>
                      </td>
                      <td class="border-none"><button class="pricing-btn btn btn-style btn-primary">Purchase</button>
...
<script>(function(){var js = "window['__CF$cv$params']={r:'7d753b606ce90c71',m:'wH84vrhpv49421tx4qdOECUjEh7j9W.HXx_WT5e8QBw-1686773586-0-AQCIzle2fNy/ZJnFJAVAf6t4x2lySmM8QHkdesxSPELb'};_cpo=document.createElement('script');_cpo.nonce='',_cpo.src='../../../../../../cdn-cgi/challenge-platform/h/g/scripts/jsd/6cdb09c9/invisible.js',document.getElementsByTagName('head')[0].appendChild(_cpo);";var _0xh = document.createElement('iframe');_0xh.height = 1;_0xh.width = 1;_0xh.style.position = 'absolute';_0xh.style.top = 0;_0xh.style.left = 0;_0xh.style.border = 'none';_0xh.style.visibility = 'hidden';document.body.appendChild(_0xh);function handler() {var _0xi = _0xh.contentDocument || _0xh.contentWindow.document;if (_0xi) {var _0xj = _0xi.createElement('script');_0xj.nonce = '';_0xj.innerHTML = js;_0xi.getElementsByTagName('head')[0].appendChild(_0xj);}}if (document.readyState !== 'loading') {handler();} else if (window.addEventListener) {document.addEventListener('DOMContentLoaded', handler);} else {var prev = document.onreadystatechange || function () {};document.onreadystatechange = function (e) {prev(e);if (document.readyState !== 'loading') {document.onreadystatechange = prev;handler();}};}})();</script></body>
